 ...
 *  @param {functoin} callback - callback function (for vorpal)
 *  @returns {promise} we return this promise for testing
 *  @returns {promise} - returning a promise for testing
 */
